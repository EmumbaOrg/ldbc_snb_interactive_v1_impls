...
export CONNECTION_STRING="${CONNECTION_STRING:-postgresql://postgres:admin123@localhost:5432/ldbcsnb}"
...
echo "Parsed connection: user=${_LOCAL_USER} pass=${_LOCAL_PASS} host:port=${_LOCAL_HOSTPORT} db=${_LOCAL_DB} endpoint=${_LOCAL_ENDPOINT}"
