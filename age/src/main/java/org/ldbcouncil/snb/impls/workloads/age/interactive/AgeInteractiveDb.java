package org.ldbcouncil.snb.impls.workloads.age.interactive;

import org.ldbcouncil.snb.driver.DbException;
import org.ldbcouncil.snb.driver.control.LoggingService;
import org.ldbcouncil.snb.driver.workloads.interactive.*;
import org.ldbcouncil.snb.impls.workloads.age.AgeDb;
import org.ldbcouncil.snb.impls.workloads.age.operationhandlers.AgeIC13OperationHandler;
import org.ldbcouncil.snb.impls.workloads.age.operationhandlers.AgeIC14OperationHandler;

import java.util.Map;

public class AgeInteractiveDb extends AgeDb {
    ...
    protected void onInit(Map<String, String> properties, LoggingService loggingService) throws DbException {
        ...
        registerOperationHandler(LdbcQuery13.class, AgeIC13OperationHandler.class);
        registerOperationHandler(LdbcQuery14.class, AgeIC14OperationHandler.class);
